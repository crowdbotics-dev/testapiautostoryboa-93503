...
## Project Structure
    ...
    ├── testapiautostoryboa_93503  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_93503`
...
2. Clone this repo and `cd testapiautostoryboa_93503`
